        ...
        <Table size="small" id="grid-attendants">
          <TableHead>
            <TableRow>
              ...
              <TableCell className={classes.compactCell} align="center">{i18n.t("reports.table.id")}</TableCell>
              <TableCell className={classes.compactCell} align="left">{i18n.t("reports.table.whatsapp")}</TableCell>
              <TableCell className={classes.compactCell} align="left">{i18n.t("reports.table.contact")}</TableCell>
              <TableCell className={classes.compactCell} align="left">{i18n.t("reports.table.user")}</TableCell>
              <TableCell className={classes.compactCell} align="left">{i18n.t("reports.table.queue")}</TableCell>
              <TableCell className={classes.compactCell} align="center">{i18n.t("reports.table.status")}</TableCell>
              <TableCell className={classes.compactCell} align="center">{i18n.t("reports.table.dateOpen")}</TableCell>
              <TableCell className={classes.compactCell} align="center">{i18n.t("reports.table.dateClose")}</TableCell>
              <TableCell className={classes.compactCell} align="center">{i18n.t("reports.table.supportTime")}</TableCell>
              <TableCell className={classes.compactCell} align="center">{i18n.t("reports.table.NPS")}</TableCell>
              <TableCell className={classes.compactCell} align="center">{i18n.t("reports.table.actions")}</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            <>
              {tickets.map((ticket) => (
                <TableRow key={ticket.id}>
                  <TableCell className={classes.compactCell} align="center">{ticket.id}</TableCell>
                  <TableCell className={classes.compactCell} align="left">{ticket?.whatsappName}</TableCell>
                  <TableCell className={classes.compactCell} align="left">{ticket?.contactName}</TableCell>
                  <TableCell className={classes.compactCell} align="left">{ticket?.userName}</TableCell>
                  <TableCell className={classes.compactCell} align="left">{ticket?.queueName}</TableCell>
                  <TableCell className={classes.compactCell} align="center">{ticket?.status}</TableCell>
                  <TableCell className={classes.compactCell} align="center">{ticket?.createdAt}</TableCell>
                  <TableCell className={classes.compactCell} align="center">{ticket?.closedAt}</TableCell>
                  <TableCell className={classes.compactCell} align="center">{ticket?.supportTime}</TableCell>
                  <TableCell className={classes.compactCell} align="center">{ticket?.NPS}</TableCell>
                  <TableCell className={classes.compactCell} align="center">
                    <Typography
                      noWrap
                      component="span"
                      variant="body2"
